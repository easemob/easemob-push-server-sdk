...
import com.easemob.push.common.DeviceType;
...
public class Platform implements PushModel {
    ...
    public static class Builder {
        ...
        public Platform build() {
            Preconditions.checkArgument(!(all && null != deviceTypes),
                    "Since all is enabled, any platform should not be set.");
            Preconditions
                    .checkArgument(!(!all && null == deviceTypes), "No any deviceType is set.");
