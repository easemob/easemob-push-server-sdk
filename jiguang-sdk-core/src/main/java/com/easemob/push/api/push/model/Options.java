    ...
    public static class Builder {
        ...
        public Map<String, Map<String, String>> getThirdPartyChannel() {
            if (null != thirdPartyChannel) {
                Map<String, Map<String, String>> thirdPartyChannelRsp =
                ...
                for (Map.Entry<String, JsonObject> entry : entrySet) {
                    ...
                    for (Map.Entry<String, JsonElement> valueEntry : valueEntrySet) {
                        valueMap.put(valueEntry.getKey(), null == valueEntry.getValue() ?
                                null :
        ...
        public Options build() {
            ...
            Preconditions
                    .checkArgument(overrideMsgId >= 0, "override_msg_id should be greater than 0.");
            Preconditions.checkArgument(timeToLive >= NONE_TIME_TO_LIVE,
                    "time_to_live should be greater than 0.");
            Preconditions.checkArgument(bigPushDuration >= 0,
                    "bigPushDuration should be greater than 0.");
            ...
            return new Options(sendno, overrideMsgId, timeToLive, apnsProduction, bigPushDuration,
                    apnsCollapseId, thirdPartyChannel, customData);
        }
    }
