...
import com.easemob.push.api.push.model.EncryptKeys;
import com.easemob.push.api.push.model.EncryptPushPayload;
...
public class PushClient {
    ...
    /**
     * This will be removed in the future. Please use ClientConfig{jiguang-common com.easemob.push.common.ClientConfig} instead of this constructor.
     *
     * @param masterSecret  API access secret of the appKey.
     * @param appKey        The KEY of one application on JPush.
    ...
    /**
     * This will be removed in the future. Please use ClientConfig{jiguang-common com.easemob.push.common.ClientConfig#setGlobalPushSetting} instead of this method.
     *
     * @param apnsProduction Global APNs environment setting. It will override PushPayload Options.
     * @param timeToLive     Global time_to_live setting. It will override PushPayload Options.
     */
    ...
    public PushResult sendPush(PushPayload pushPayload)
        ...
        ResponseWrapper response =
                _httpClient.sendPost(_baseUrl + _pushPath, getEncryptData(pushPayload));
    ...
    public PushResult sendPushValidate(PushPayload pushPayload)
        ...
        ResponseWrapper response =
                _httpClient.sendPost(_baseUrl + _pushValidatePath, getEncryptData(pushPayload));
    ...
    public PushResult sendPush(String payloadString)
        ...
        ResponseWrapper response =
                _httpClient.sendPost(_baseUrl + _pushPath, getEncryptData(payloadString));
    ...
    public PushResult sendFilePush(PushPayload pushPayload)
        ...
        ResponseWrapper response =
                _httpClient.sendPost(_baseUrl + _filePushPath, getEncryptData(pushPayload));
    ...
    public PushResult sendPushValidate(String payloadString)
        ...
        ResponseWrapper response =
                _httpClient.sendPost(_baseUrl + _pushValidatePath, getEncryptData(payloadString));
    ...
    public BatchPushResult batchSendPush(String url, List<PushPayload> pushPayloadList)
        ...
        ResponseWrapper response =
                _httpClient.sendPost(url, getEncryptData(gson.toJson(contentJson)));
    ...
    public CIDResult getCidList(int count, String type)
        ...
        if (type != null) {
            responseWrapper = _httpClient
                    .sendGet(_baseUrl + _pushPath + "/cid?count=" + count + "&type=" + type);
        } else {
    ...
    public DefaultResult deletePush(String msgId)
        ...
        ResponseWrapper responseWrapper =
                _httpClient.sendDelete(_baseUrl + _pushPath + "/" + msgId);
    ...
    private String getEncryptData(String pushPayload, Audience audience) {
        ...
        if (EncryptKeys.ENCRYPT_SMS2_TYPE.equals(_encryptType)) {
            ...
            try {
                encryptPushPayload.setPayload(String.valueOf(Base64.encode(
                        SM2Util.encrypt(pushPayload, EncryptKeys.DEFAULT_SM2_ENCRYPT_KEY))));
            } catch (Exception e) {
                throw new RuntimeException("encrypt word exception", e);
            }
