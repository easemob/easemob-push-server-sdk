...
import com.easemob.push.common.Week;
...
import com.easemob.push.api.device.AliasDeviceListResult;
import com.easemob.push.api.device.DeviceClient;
import com.easemob.push.api.device.OnlineStatus;
import com.easemob.push.api.device.TagAliasResult;
import com.easemob.push.api.device.TagListResult;
import com.easemob.push.api.push.CIDResult;
import com.easemob.push.api.push.PushClient;
import com.easemob.push.api.push.PushResult;
import com.easemob.push.api.push.model.BatchPushResult;
import com.easemob.push.api.push.model.Message;
import com.easemob.push.api.push.model.Platform;
import com.easemob.push.api.push.model.PushPayload;
import com.easemob.push.api.push.model.SMS;
import com.easemob.push.api.push.model.audience.Audience;
import com.easemob.push.api.push.model.notification.IosAlert;
import com.easemob.push.api.push.model.notification.Notification;
import com.easemob.push.api.report.GroupMessageDetailResult;
import com.easemob.push.api.report.GroupUsersResult;
import com.easemob.push.api.report.MessageDetailResult;
import com.easemob.push.api.report.MessageStatus;
import com.easemob.push.api.report.MessagesResult;
import com.easemob.push.api.report.ReceivedsResult;
import com.easemob.push.api.report.ReportClient;
import com.easemob.push.api.report.UsersResult;
import com.easemob.push.api.report.model.CheckMessagePayload;
import com.easemob.push.api.schedule.ScheduleClient;
import com.easemob.push.api.schedule.ScheduleListResult;
import com.easemob.push.api.schedule.ScheduleMsgIdsResult;
import com.easemob.push.api.schedule.ScheduleResult;
import com.easemob.push.api.schedule.model.SchedulePayload;
import com.easemob.push.api.schedule.model.TriggerPayload;
...
public class JPushClient {
    ...
    public GroupUsersResult getGroupReportUsers(TimeUnit timeUnit, String start, int duration)
     ...
     * @throws APIRequestException    if a request exception occurs.
     */
    public ScheduleResult createDailySchedule(String name, String start, String end, String time,
            PushPayload push,
     ...
     * @throws APIRequestException    if a request exception occurs.
     */
    public ScheduleResult createWeeklySchedule(String name, String start, String end, String time,
            Week[] days,
            PushPayload push, String masterSecret, String appKey)
            throws APIConnectionException, APIRequestException {
    ...
    public ScheduleResult createWeeklySchedule(String name, String start, String end, String time,
        ...
        return createPeriodicalSchedule(name, start, end, time, TimeUnit.WEEK, frequency, points,
                push, masterSecret, appKey);
    }
     ...
     * @throws APIRequestException    if a request exception occurs.
     */
    public ScheduleResult createMonthlySchedule(String name, String start, String end, String time,
            String[] points,
            PushPayload push, String masterSecret, String appKey)
            throws APIConnectionException, APIRequestException {
        Preconditions.checkArgument(null != points && points.length > 0,
     ...
     */
    public ScheduleResult createMonthlySchedule(String name, String start, String end, String time,
            int frequency, String[] points,
            PushPayload push, String masterSecret, String appKey)
            throws APIConnectionException, APIRequestException {
        Preconditions.checkArgument(null != points && points.length > 0,
                "The points must not be empty.");
        return createPeriodicalSchedule(name, start, end, time, TimeUnit.MONTH, frequency, points,
                push, masterSecret, appKey);
    }
    ...
    private ScheduleResult createPeriodicalSchedule(String name, String start, String end,
            String time,
