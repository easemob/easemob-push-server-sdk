package com.easemob.pushapi.push.model.audience;
...
public class Audience implements PushModel {
    ...
    public static class Builder {
        ...
        public Audience build() {
            Preconditions.checkArgument(!(all && null != audienceBuilder),
                    "If audience is all, no any other audience may be set.");
            Preconditions.checkArgument(!(all == false && null == audienceBuilder),
                    "No any audience target is set.");
