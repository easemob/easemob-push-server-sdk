...
public class ClientConfig extends HashMap<String, Object> {
    ...
    public static final String REPORT_GROUP_MESSAGE_DETAIL_PATH =
            "report.group.message.detail.path";
    ...
    /**
     * Setup custom device api host name, if using the EPush privacy cloud.
     *
     * @param hostName the custom api host name, default is EPush domain name
     */
    ...
    /**
     * Setup custom push api host name, if using the EPush privacy cloud.
     *
     * @param hostName the custom api host name, default is EPush domain name
     */
    ...
    /**
     * Setup custom report api host name, if using the EPush privacy cloud.
     *
     * @param hostName the custom api host name, default is EPush domain name
     */
